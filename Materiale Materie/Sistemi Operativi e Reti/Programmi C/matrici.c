...
int main()
{
    ...
    if(primo == 0)
    {
        ...
        //questa istruzione va messa ogni volta che si vuole utilizzare la funzione random
    ...
    else
    {
        ...
        else
        {
            ...
            int arrayRicevuto1[3], arrayRicevuto2[3];

            //leggo gli array inviati dai figli
            read(pipePrima[READ], &arrayRicevuto1, sizeof(int)*3 );
            read(pipeSeconda[READ], &arrayRicevuto2, sizeof(int)*3);
            ...
            for(int i = 0; i < 3; i++)
            {
                matrice[i][0] = arrayRicevuto1[i];
            }
            //copio i numeri presenti nel secondo array nella seconda colonna della matrice (array inviato dal secondo figlio)
            for(int i = 0; i < 3; i++)
            {
                matrice[i][1] = arrayRicevuto2[i];
            }
            //stampo la matrice
