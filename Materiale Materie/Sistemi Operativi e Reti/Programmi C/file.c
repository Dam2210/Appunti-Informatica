...
#define filePath "/home/dam2210/Documents/Università e Appunti/lezioni.txt" //definisco la costante filePath con il valore directory/input.txt che rappresenta il percorso del file da leggere
...
int main()
{
    ...
    else
    {
        ...
        else
        {
            ...
            read(pipe1[READ],&pidFiglio1,sizeof(pidFiglio1)); //leggo il pid del primo figlio e lo memorizzo nella variabile pidFiglio1
            read(pipe2[READ],&pidFiglio2,sizeof(pidFiglio2)); //stessa cosa per il secondo figlio
